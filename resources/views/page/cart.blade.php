...
<!-- Mirrored from ncodetechnologies.com/OrganicFoodStore/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jun 2020 02:13:52 GMT -->
<head>
      <meta charset="utf-8">
               ...
               <table class="table table-hover table-responsive">
                  ...
                  <tfoot>
                     <tr>
                        <td colspan="6">
                           <div class="l-part">
                              <a class="continue-shopping-btn" href="#">Continue with Shopping<i class="icon-right-arrow-1"></i></a>
                           </div>
                           <div class="r-part">
                              <a class="cancle-cart-btn" href="#"><i class="icon-cancel-music"></i>cancle cart</a>
               ...
               <div class="col-md-5 col-sm-6 col-sm-12 pull-right">
                  <div class="total-box">
                     ...
                     <div class="total-box-inner">
                        ...
                        <div class="grand-total"><span>Grand Total </span><span class="price">$129.00</span></div>
               ...
               <div class="col-md-7 col-sm-6 col-sm-12 pull-left">
                  <div class="tax-box">
                     ...
                     <div class="tax-box-inner">
                        ...
                        <input class="postal-text" type="text" name="postal-text" />
