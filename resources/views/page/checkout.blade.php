...
<!-- Mirrored from ncodetechnologies.com/OrganicFoodStore/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jun 2020 02:13:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="content-part checkout-page">
      <div class="container">
        <div class="checkout-step-one text-left">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <h2 class="checkout-head">01 / Checkout Method</h2>
                ...
                <form>
                  <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="name" class="form-control" placeholder="User name or Email" />
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="row">
                <div class="checkout-two-form text-left">
                  <form>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="apt" class="form-control" placeholder="Apt, suite, etc. (optinal)" />
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="selectdiv">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <label>
                      <input name="save info" type="checkbox">
                      <span> Save this information for next time</span></label>
                      <textarea rows="5" placeholder="Order notes" class="form-control" name="ordernotes"> </textarea>
                      <label>
                      <input type="checkbox" value="" name="add check"/>
        ...
        <div class="checkout-step-three text-left">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <h2 class="checkout-head">03 / Payment information</h2>
              <div class="center row">
                <div class="card-list"><span>Credit card (PayPal)</span> <img src="images/card-list.png" alt="credit card" class="img-responsive"/></div>
                  ...
                  <form>
                    <div class="row">
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="c number" class="form-control" placeholder="Card Number" />
                      </div>
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="date" name="expiry" class="form-control" data-placeholder="Expiry (MM/YY)" />
                      </div>
                      <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="card code" class="form-control" placeholder="Card Code" />
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12">
...
<!-- Mirrored from ncodetechnologies.com/OrganicFoodStore/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jun 2020 02:13:29 GMT -->
</html>
